...
public class EncryptUtil {
	 ...
	 * 
	 * 일반적으로 암호화 알고리즘 SHA-256을 통해서만 암호화 시킬 경우, 암호화 된 값만 보고 일반적인
	 * 비밀번호에 대한 값을 쉽게 예측이 가능함 따라서, 암호화 할 때 암호화되는 값에 추가적인 문자열을 붙여서 함께 암호화를 진행함
	 */
	
	final static String addMessage = "kangjaenam";
	...
	final static String key = "kangjaenam123456"; //16글자(영문자 1글자당 1바이트임)
	 ...
	 * AES128 CBC 복호화 함수
	 * 
	 * 128은 암호화 길이를 의미함 128비트는 = 16바이트(1바이트 = 8비트 * 16 = 128)
	 */
